<section style="text-align: center; padding: 40px 0; border-bottom: 1px solid #e2e8f0;">
    ...
    <a href="/contato" style="background: #1e3a8a; color: white; text-decoration: none; padding: 12px 30px; border-radius: 4px; font-weight: bold; border-bottom: 3px solid #d4af37;">Fale com um Especialista</a>
</section>
...
<div class="card-grid">
    <?php foreach ($artigos as $artigo): ?>
        <div class="card">
            ...
            <a href="/blog" style="color: #111; font-weight: bold; text-decoration: none; font-size: 14px; border-bottom: 2px solid #d4af37;">Ler Artigo completo &rarr;</a>
        </div>
    <?php endforeach; ?>
</div>
